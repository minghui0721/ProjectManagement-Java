 ...
 * @author mingh
 */
public class ViewHandleProject extends javax.swing.JFrame {

    private Lecturer lecturer;
    private String role;
    private String lecturerId;
    public ViewHandleProject(Lecturer lecturer) {
        initComponents();
        ...
        String roleLec = lecturer.getRole();
        if(roleLec.equals("Lecturer")){
            jLabel7.setText("Supervisee");
        }else if(roleLec.equals("Supervisor")){
            jLabel7.setText("Result");
        }else if(roleLec.equals("Second Marker")){
            jLabel7.setText("Result");
        }else{
    ...
    private void loadSupervisorCourses() {
        ...
        for (String course : courses) {
            String[] parts = course.split("\\|");
            if (parts.length >= 10 && (parts[5].equals(lecturer.getId()))) { // Compare lecturerName with columns 5 and 6{ // Compare intake with the 7th column
                ...
                coursePanel.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseExited(MouseEvent e) {
                        coursePanel.setBackground(new Color(29, 37, 78)); // Restore original background color on exit
                    }

                    @Override
                    public void mousePressed(MouseEvent e) {
                        coursePanel.setBackground(new Color(105, 87, 233));
                    }
    ...
    private void loadSecondMarkerCourses() {
        // Read courses from the text file
        List<String> courses = CourseReader.readCoursesFromFile("project_details.txt");
        ...
        for (String course : courses) {
            String[] parts = course.split("\\|");
            if (parts.length >= 10 && (parts[6].equals(lecturer.getId()))) { // Compare lecturerName with columns 5 and 6{ // Compare intake with the 7th column
                String courseName = parts[1];
                String projectID = parts[0];
    ...
    private JPanel createCoursePanel(String courseName, String projectID) {
        ...
        panel.setBackground(new Color(29, 37, 78));
    ...
    private void roundedPanelMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanelMouseReleased
        ...
        // Close the current JFrame (enclosing frame of StudentMenu class)
        this.dispose();
        Lecturer lecturer = new Supervisor("lecturer.txt", lecturerId);
