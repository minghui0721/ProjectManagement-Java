 ...
 * @author mingh
 */
public class GradedRecords extends javax.swing.JFrame {

    private Lecturer lecturer;
    private String lecturerID;

    public GradedRecords(Lecturer lecturer) {
        initComponents();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("student.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                table1.addRow(new Object[]{studentID, studentName, email, gender, intakeCode});
            }
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        roundedPanel4.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        roundedPanel5.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Gender", "Intake Code"
            }
        ) {
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        GradedRecords viewProfile = new GradedRecords(lecturer);
    ...
    private void roundedPanelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanelMouseExited
        // TODO add your handling code here:
        resetColor(roundedPanel, jLabel16);
