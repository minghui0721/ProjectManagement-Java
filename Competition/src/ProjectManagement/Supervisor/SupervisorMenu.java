...
public class SupervisorMenu extends javax.swing.JFrame {
    ...
    public SupervisorMenu(Lecturer lecturer) {
        ...
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Project", totalProjectsString, "Supervisor"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Presentation", Integer.toString(totalPresentationRequest), "Request"));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Submission", totalSubmissionString, "All Projects"));
        ...
        jPanel2.setFocusTraversalPolicy(new LayoutFocusTraversalPolicy() {
            ...
            public Component getDefaultComponent(Container focusCycleRoot) {
                return jTextField2; // Set your search bar here
            }
        });
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Supervisor Dashboard");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Intake", "Project", "Start Date", "End Date", "Submission Status", "Grading Status"
            }
        ) {
        ...
        jTextField2.setBackground(new java.awt.Color(105, 87, 233));
        jTextField2.setFont(new java.awt.Font("Franklin Gothic Medium", 1, 12)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(255, 255, 255));
        jTextField2.setText("Search by Student Name");
        jTextField2.setToolTipText("Search by Student Name");
    ...
    private Map<String, String[]> readSupervisorHandle() {
    ...
    public Object[][] getRowData() {
        ...
        Map<String, String[]> projectDetailsMap = readSupervisorHandle();
        ...
        for (Map.Entry<String, String[]> entry : projectDetailsMap.entrySet()) {
            ...
            for (String[] studentRecord : studentRecords) {
                ...
                String submissionStatus = lecturer.submissionAndGradingStatus(studentID, projectID);

                // Check grading status
                String gradingStatus = checkGradingStatus(studentID, projectID) ? "Graded" : "Ungraded";

                rowDataList.add(new Object[]{studentID, fullName, intake, projectName, startDate, endDate, submissionStatus, gradingStatus});
            }
        }
...
// Method to check if grading exists for a student and project
    ...
    private void roundedPanel3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel3MouseReleased
        // TODO add your handling code here:
        PendingForFinalise finalise = new PendingForFinalise(lecturer);
        finalise.setVisible(true);
        dispose();
    ...
    private void jTextField2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField2FocusGained
        // TODO add your handling code here:
        jTextField2.setText(""); // Clear the text when the field is clicked
