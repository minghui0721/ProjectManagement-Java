...
public class AddAdmin extends javax.swing.JFrame {
    ...
    public AddAdmin(Admin admin) {
        ...
        studentIDText.setText(generateAdminID());
    ...
    //    Object intakecode = selectModule.getSelectedItem();
        ...
        try (FileWriter writer = new FileWriter("admin.txt", true); BufferedWriter bw = new BufferedWriter(writer)) {
            bw.write(id + "|" + password + "|" + fname + "|" + lname + "|" + email + "|" + gender + "|" + address + "|" + phone + "|" + IC + "|" + role);
            bw.newLine();
            JOptionPane.showMessageDialog(this, "Admin added successfully.");
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error occur.");
            JOptionPane.showMessageDialog(this, "Error occurred while adding Admin.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private String generateAdminID() {
        ...
        String lastStudentID = getLastAdminIDFromFile();
        ...
        String nextStudentID = String.format("AP%03d", nextNumber);
    ...
    private String getLastAdminIDFromFile() {
        String lastAdminID = "AP000"; // Default value in case the file is empty
        try (BufferedReader reader = new BufferedReader(new FileReader("admin.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                lastAdminID = line.split("\\|")[0]; // Extract the student ID from each line
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error occur.");
        }
