...
public class AdminDashboard extends javax.swing.JFrame {
    ...
    public AdminDashboard(Admin admin) {
        ...
        try (BufferedReader studentReader = new BufferedReader(new FileReader("student.txt"))) {
            while (studentReader.readLine() != null) {
                totalStudents++;
            }
        } catch (IOException e) {
        ...
        // Count total lecturers and project managers
        try (BufferedReader lecturerReader = new BufferedReader(new FileReader("lecturer.txt"))) {
            String line;
            while ((line = lecturerReader.readLine()) != null) {
                totalLecturer++;
                String[] parts = line.split("\\|");
                if (parts.length >= 10 && parts[10].equals("Project Manager")) {
                    totalPM++;
                }
            }
        } catch (IOException e) {
        ...
        int recordNumber = 1; // to keep track of the number of entries

        // Read student data
        try (BufferedReader studentReader = new BufferedReader(new FileReader("student.txt"))) {
            String line;
            while ((line = studentReader.readLine()) != null) {
                String[] parts = line.split("\\|"); // assuming the file is pipe-separated
                String[] row = {
                    String.valueOf(recordNumber++), // number (sequential count)
                    parts[0], // userid
                    "Student", // userrole
                    ...
                    parts[6], // address
                    parts[7], // phone
                    parts[9] // ic (parts[8] is ignored as it doesn't match your table fields)
                };
                tableData.add(row);
            }
        } catch (IOException e) {
        ...
        String[] columnNames = {"Number", "User ID", "User Role", "Name", "Email", "Gender", "Address", "Phone", "IC"};
        ...
        // Assuming you have a JTable named studentLecturerTable
        StudentLecturerTable.setModel(tableModel);

        //Card
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Students", String.valueOf(totalStudents), "Add Student"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Lecturer", String.valueOf(totalLecturer), "Add Lecturer"));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Project Manager", String.valueOf(totalPM), "Assign Project Manager"));
    ...
    private void initComponents() {
        ...
        StudentLecturerTable = new ProjectManagement.Admin.Table();
        card1 = new ProjectManagement.Admin.Card();
        card2 = new ProjectManagement.Admin.Card();
        card3 = new ProjectManagement.Admin.Card();
        ...
        StudentLecturerTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "No.", "User ID", "Role", "Name", "Email", "Gender", "Address", "Phone", "IC"
            }
        ) {
        ...
        jScrollPane1.setViewportView(StudentLecturerTable);
        if (StudentLecturerTable.getColumnModel().getColumnCount() > 0) {
            StudentLecturerTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        }
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(card1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(card2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(card3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19)
    ...
    private void card1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_card1MouseReleased
        this.dispose();
        addStudent AddStudent = new addStudent(admin);
    ...
    private void card3MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_card3MouseReleased
        this.dispose();
        PM_Lecturer pmlecturer = new PM_Lecturer(admin);
        pmlecturer.setVisible(true);
    ...
    private ProjectManagement.Admin.Table StudentLecturerTable;
    private ProjectManagement.Admin.Card card1;
    private ProjectManagement.Admin.Card card2;
    private ProjectManagement.Admin.Card card3;
