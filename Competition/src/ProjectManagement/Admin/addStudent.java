...
public class addStudent extends javax.swing.JFrame {
    ...
    public addStudent(Admin admin) {
        ...
        studentIDText.setText(generateStudentID());
    ...
    private void addStudent() {
        ...
        String password = passwordTexxt.getText();
        String fname = FnameText.getText();
        String lname = LnameText.getText();
        String email = emailtext.getText();
        Object gender = genderText.getSelectedItem();
        ...
        try (FileWriter writer = new FileWriter("student.txt", true); BufferedWriter bw = new BufferedWriter(writer)) {
            bw.write(id + "|" + password + "|" + fname + "|" + lname + "|" + email + "|" + gender + "|" + address + "|" + phone + "|" + intakecode + "|" + IC);
            bw.newLine();
    ...
    private void initComponents() {
        ...
        passwordTexxt = new javax.swing.JPasswordField();
        ...
        passwordTexxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                passwordTexxtActionPerformed(evt);
            }
        });
        ...
        selectModule.setBackground(new java.awt.Color(204, 204, 204));
        selectModule.setForeground(new java.awt.Color(51, 51, 51));
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(passwordTexxt, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(passwordTexxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(27, 27, 27)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(selectModule, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                        .addGap(20, 20, 20)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        AddButton.setBackground(new java.awt.Color(153, 153, 0));
    ...
    public static List<String> findIntakeCode() {
        List<String> intakeCode = new ArrayList<>();

        try (BufferedReader br = new BufferedReader(new FileReader("IntakeCode.txt"))) {
            String line;
            while ((line = br.readLine()) != null) {
                String[] parts = line.split("\\|");
                if (parts.length >= 1) {
                    // Assuming modules are listed in the sixth field (index 5)
                    intakeCode.add(parts[0]);
                }
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error occur.");
    ...
    private String generateStudentID() {
        // Read the last student ID from the file
        String lastStudentID = getLastStudentIDFromFile();

        // Extract the numeric part and increment it by one
        int lastNumber = Integer.parseInt(lastStudentID.substring(2)); // Extract numeric part after "TP"
        int nextNumber = lastNumber + 1;

        // Generate the next student ID
        String nextStudentID = String.format("TP%03d", nextNumber);

        // Update the studentIDText GUI component
        studentIDText.setText(nextStudentID);

        return nextStudentID;
    }

    private String getLastStudentIDFromFile() {
        String lastStudentID = "TP000"; // Default value in case the file is empty
        try (BufferedReader reader = new BufferedReader(new FileReader("student.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                lastStudentID = line.split("\\|")[0]; // Extract the student ID from each line
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error occur.");
        }
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        if (!isValidIC(IC)) {
            JOptionPane.showMessageDialog(this, "Invalid IC number format. IC number should be in the format: xxxxxx-xx-xxxx.", "Error", JOptionPane.ERROR_MESSAGE);
            ICText.setText("");

            return; // Exit the method if IC number is invalid
        } // Validate email
        ...
        if (intakecode.equals("Select Intake")) {
            JOptionPane.showMessageDialog(this, "Please select a intake.");
            return;
        }
    ...
    private void passwordTexxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passwordTexxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_passwordTexxtActionPerformed
    ...
    private boolean isValidName(String name) {
        // Regular expression to match only letters (no numeric or special characters)
        String regex = "^[a-zA-Z]+$";
    ...
    private javax.swing.JPasswordField passwordTexxt;
