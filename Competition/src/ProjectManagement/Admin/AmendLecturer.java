 ...
 * @author mingh
 */
public class AmendLecturer extends javax.swing.JFrame {
    ...
    static String Estatus;
     ...
     private Admin admin;
    public AmendLecturer(Admin admin) {
        initComponents();
        this.setTitle("Lecturer");
        this.admin = admin;
        Lecturertable.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        //set admin name
            ...
            String line;
                while ((line = reader.readLine()) != null) {
                    ...
                    if(components.length == 12){
                        ...
                        String IcNumber  = components[7];
                        String address  = components[8];
                        String year = components[9];
                        String positions = components[10];
                        String status  = components[11];
                         

                        //Add data to table
                           Lecturertable.addRow(new Object[]{LecturerID,firstName,lastName,email,gender,phoneNumber,IcNumber ,address,year,positions,status});
    ...
    private void initComponents() {
        ...
        Lecturertable = new ProjectManagement.Admin.Table();
        ...
        jLabel12.setText("Lecturer List");
        ...
        Lecturertable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " Lecturer ID", "First Name", "Last Name", "Email", "Gender", "Phone", "IC", "Address", "Year", "Positions", "Status"
            }
        ));
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        int selectedRowIndex = Lecturertable.getSelectedRow();
        ...
        Object SpnumberObj = Lecturertable.getValueAt(selectedRowIndex, 0);
        AmendLecturer.Spnumber = SpnumberObj.toString();
        
//        Object passwordObj = Lecturertable.getValueAt(selectedRowIndex, 1);
//        AmendLecturer.Epassword = passwordObj.toString();

        Object fnameObj = Lecturertable.getValueAt(selectedRowIndex, 1);
        AmendLecturer.Efname = fnameObj.toString();
        
        Object lnameObj = Lecturertable.getValueAt(selectedRowIndex, 2);
        AmendLecturer.Elname = lnameObj.toString();
        
        Object emailObj = Lecturertable.getValueAt(selectedRowIndex, 3);
        AmendLecturer.Eemail = emailObj.toString();
        
        Object genderObj = Lecturertable.getValueAt(selectedRowIndex, 4);
        AmendLecturer.Egender = genderObj.toString();
        
        Object phoneObj = Lecturertable.getValueAt(selectedRowIndex, 5);
        AmendLecturer.Ephone = phoneObj.toString();
        
        Object icObj = Lecturertable.getValueAt(selectedRowIndex, 6);
        AmendLecturer.Eic = icObj.toString();
        
        Object addressObj = Lecturertable.getValueAt(selectedRowIndex, 7);
        AmendLecturer.Eaddress = addressObj.toString();
        
        Object yearObj = Lecturertable.getValueAt(selectedRowIndex, 8);
        AmendLecturer.Eyear = yearObj.toString();
        
        Object positionObj = Lecturertable.getValueAt(selectedRowIndex, 9);
        AmendLecturer.Eposition = positionObj.toString();
        
        Object statusObj = Lecturertable.getValueAt(selectedRowIndex, 10);
        AmendLecturer.Estatus = statusObj.toString();
        
        EditLecturer editLecturer = new EditLecturer(admin, AmendLecturer.Spnumber,password,AmendLecturer.Efname,AmendLecturer.Elname,AmendLecturer.Eemail,AmendLecturer.Egender,AmendLecturer.Ephone,AmendLecturer.Eic ,AmendLecturer.Eaddress,AmendLecturer.Eyear, AmendLecturer.Eposition, AmendLecturer.Estatus);
    ...
    private void BackButton(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BackButton
        // TODO add your handling code here:
        this.dispose();
        Register back = new Register(admin);
        back.setVisible(true);
    }//GEN-LAST:event_BackButton

    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
         int selectedRow = Lecturertable.getSelectedRow(); // Get the index of the selected row
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmendLecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public String getSpnumber(){
        return AmendLecturer.Spnumber;
    }
    
    public String getpassword(){
        return AmendLecturer.Epassword;
    }
    
    public String getfname(){
        return AmendLecturer.Efname;
    }
    
    public String getlname(){
        return AmendLecturer.Elname;
    }
    
    public String getemail(){
        return AmendLecturer.Eemail;
    }

    public String getgender(){
        return AmendLecturer.Egender;
    }
    
    public String getphone(){
        return AmendLecturer.Ephone;
    }
    
    public String getic(){
        return AmendLecturer.Eic;
    }
    
    public String getaddress(){
        return AmendLecturer.Eaddress;
    }
    
    public String getyear(){
        return AmendLecturer.Eyear;
    }
    
    public String getposition(){
        return AmendLecturer.Eposition;
    }
    
    public String getstatus(){
        return AmendLecturer.Estatus;
    }
    
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private ProjectManagement.Admin.Table Lecturertable;
