 ...
 * @author mingh
 */
public class PM_Lecturer extends javax.swing.JFrame {
    ...
    static String Egender;
    static String Ephone;
    static String Eic;
    ...
    private String year;
    private Admin admin;
    public PM_Lecturer(Admin admin) {
        initComponents();
        this.setTitle("Project Manager and Lecturer");
        this.admin = admin;
        PMLectable.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        //set admin name
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("lecturer.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (components.length == 12
                        && (components[10].equals("Project Manager") || components[10].equals("Lecturer"))) // ... data extraction and table update logic
                {

                    String lecturerID = components[0];
                    String LecturerPassword  = components[1];
                    this.password = LecturerPassword;
                    String firstName = components[2];
                    String lastName = components[3];
                    String Lecemail  = components[4];
                    this.email = Lecemail;
                    String Lecgender  = components[5];
                    this.gender = Lecgender;
                    String LecphoneNumber  = components[6];
                    this.phone = LecphoneNumber;
                    String LecIcNumber  = components[7];
                    this.ic = LecIcNumber;
                    String Lecaddress  = components[8];
                    this.address = Lecaddress;
                    String Lecyear = components[9];
                    this.year = Lecyear;
                    String positions = components[10];
                    String status = components[11];

                    // Add data to table
                    PMLectable.addRow(new Object[]{lecturerID, firstName, lastName, positions, status});
                }
            }
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        PMLectable = new ProjectManagement.Admin.Table();
        ...
        jLabel12.setText("Project Manager / Lecturer");
        ...
        PMLectable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID Number", "First Name", "Last Name", "Position", "Status"
            }
        ));
        jScrollPane1.setViewportView(PMLectable);
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(editButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35)
    ...
    private void roundedPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel1MouseReleased
        ...
        Register regis = new Register(admin);
    ...
    private void editButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButton1ActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) PMLectable.getModel();
        int selectedRowIndex = PMLectable.getSelectedRow();
        
        if (selectedRowIndex == -1) {
            // No row is selected, show a message to select a row
            JOptionPane.showMessageDialog(this, "Please select a Lecturer/Project Manager to edit.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        Object id = PMLectable.getValueAt(selectedRowIndex, 0);
        PM_Lecturer.Spnumber = id.toString();
        
//        Object pass = PMLectable.getValueAt(selectedRowIndex, 1);
//        PM_Lecturer.Epassword = pass.toString();
        
        Object fname = PMLectable.getValueAt(selectedRowIndex, 1);
        PM_Lecturer.Efname = fname.toString();
        
        Object lname = PMLectable.getValueAt(selectedRowIndex, 2);
        PM_Lecturer.Elname = lname.toString();
        
        /*
        Object email = PMLectable.getValueAt(selectedRowIndex, 4);
        PM_Lecturer.Eemail = email.toString();
        
        Object gender = PMLectable.getValueAt(selectedRowIndex, 5);
        PM_Lecturer.Egender = gender.toString();
        
        Object phone = PMLectable.getValueAt(selectedRowIndex, 6);
        PM_Lecturer.Ephone = phone.toString();
        
        Object ic = PMLectable.getValueAt(selectedRowIndex, 7);
        PM_Lecturer.Eic = ic.toString();
        
        Object address = PMLectable.getValueAt(selectedRowIndex, 8);
        PM_Lecturer.Eaddress = address.toString();
        
        Object year = PMLectable.getValueAt(selectedRowIndex, 9);
        PM_Lecturer.Eyear = year.toString();
        */
        
        Object position = PMLectable.getValueAt(selectedRowIndex, 3);
        PM_Lecturer.Eposition = position.toString();
        
        Object status = PMLectable.getValueAt(selectedRowIndex, 4);
        PM_Lecturer.Estatus = status.toString();
        
        ConvertPM_Lec PM_Lec = new ConvertPM_Lec(admin, PM_Lecturer.Spnumber, password,PM_Lecturer.Efname,PM_Lecturer.Elname,email,gender,phone,ic,address,year,PM_Lecturer.Eposition,PM_Lecturer.Estatus);
        PM_Lec.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_editButton1ActionPerformed

    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        // TODO add your handling code here:
        int selectedRow = PMLectable.getSelectedRow(); // Get the index of the selected row
        ...
        if (selectedRow >= 0) { // Check if a row is selected
            ...
            try {
                ...
                List<String> lines = Files.readAllLines(Paths.get("lecturer.txt"));
                ...
                Files.write(Paths.get("lecturer.txt"), lines);

                // Remove the selected row from the JTable
                model.removeRow(selectedRow);
                JOptionPane.showMessageDialog(this, "Lecturer deleted successful !");
            } catch (IOException e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PM_Lecturer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public String getSPnumber() {
        ...
        return PM_Lecturer.Spnumber;
    }
    
    public String getpassword() {

        return PM_Lecturer.Epassword;
    }
    
    public String getfname() {

        return PM_Lecturer.Efname;
    }
    
    public String getlname() {

        return PM_Lecturer.Elname;
    }
    
    public String getgender() {

        return PM_Lecturer.Egender;
    }
    
    public String getPhone() {

        return PM_Lecturer.Ephone;
    }
    
    public String getIc() {

        return PM_Lecturer.Eic;
    }
    ...
    public String getYear() {
        ...
        return PM_Lecturer.Eyear;
    }
    
    public String getPosition() {

        return PM_Lecturer.Eposition;
    }
    
    public String getEmail() {

        return PM_Lecturer.Eemail;
    }
    
    public String getStatus() {

        return PM_Lecturer.Estatus;
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private ProjectManagement.Admin.Table PMLectable;
