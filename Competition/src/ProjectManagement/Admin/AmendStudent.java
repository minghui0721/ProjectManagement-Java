 ...
 * @author mingh
 */
public class AmendStudent extends javax.swing.JFrame {

    static String TPNumber;
     ...
     */
    private Admin admin;
    public AmendStudent(Admin admin) {
        initComponents();
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("student.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (components.length == 10) {
                    ...
                    String studentPassword = components[1];
                    ...
                    String intakeCode = components[8];
                    String IcNumber = components[9];
                    //Add data to table
                    studentTable.addRow(new Object[]{studentID, firstName, lastName, email, gender, address, phoneNumber, intakeCode, IcNumber});
    ...
    private void initComponents() {
        ...
        studentTable = new ProjectManagement.Admin.Table();
        ...
        jLabel6.setText("Project Manger");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(roundedPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
        ...
        studentTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "First Name", "Last Name", "Email", "Gender", "Address", "Phone ", "Intake Code", "IC Number"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
    ...
    private void roundedPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel1MouseReleased
        ...
        Register amendstudent = new Register(admin);
        amendstudent.setVisible(true);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        Object TpnumberObj = studentTable.getValueAt(selectedRowIndex, 0);
        AmendStudent.TPNumber = TpnumberObj.toString();
...
//        AmendStudentTest.editPassword = PasswordObj.toString();
        ...
        Object FnameObj = studentTable.getValueAt(selectedRowIndex, 1);
        AmendStudent.editFname = FnameObj.toString();

        //get first name for edit form
        Object LnameObj = studentTable.getValueAt(selectedRowIndex, 2);
        AmendStudent.editLname = LnameObj.toString();

        //get first name for edit form
        Object emailObj = studentTable.getValueAt(selectedRowIndex, 3);
        AmendStudent.editemail = emailObj.toString();

        //get gender for edit form
        Object genderObj = studentTable.getValueAt(selectedRowIndex, 4);
        AmendStudent.editgender = genderObj.toString();

        //get address for edit form
        Object addressObj = studentTable.getValueAt(selectedRowIndex, 5);
        AmendStudent.editaddress = addressObj.toString();

        //get phone for edit form
        Object phoneObj = studentTable.getValueAt(selectedRowIndex, 6);
        AmendStudent.editphone = phoneObj.toString();

        //get intakecode for edit form
        Object intakeCodeObj = studentTable.getValueAt(selectedRowIndex, 7);
        AmendStudent.editintakecode = intakeCodeObj.toString();

        //get IC for edit form
        Object ICObj = studentTable.getValueAt(selectedRowIndex, 8);
        AmendStudent.editIC = ICObj.toString();
        ...
        EditStudent editStudent = new EditStudent(admin, AmendStudent.TPNumber, password, AmendStudent.editFname, AmendStudent.editLname, AmendStudent.editemail, AmendStudent.editgender, AmendStudent.editaddress, AmendStudent.editphone, AmendStudent.editintakecode, AmendStudent.editIC);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if (selectedRow >= 0) { // Check if a row is selected
            ...
            try {
                ...
                Files.write(Paths.get("student.txt"), lines);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmendStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public String getTPnumber() {
        ...
        return AmendStudent.TPNumber;
    }

    public String geteditPassword() {

        return AmendStudent.editPassword;
    }

    public String geteditFname() {

        return AmendStudent.editFname;
    }

    public String geteditLname() {

        return AmendStudent.editLname;
    }

    public String geteditemail() {

        return AmendStudent.editemail;
    }

    public String geteditgender() {

        return AmendStudent.editgender;
    }

    public String geteditaddess() {

        return AmendStudent.editaddress;
    }

    public String geteditphone() {

        return AmendStudent.editphone;
    }

    public String geteditintakecode() {

        return AmendStudent.editintakecode;
    }

    public String geteditIC() {

        return AmendStudent.editIC;
    }
    ...
    private ProjectManagement.Admin.Table studentTable;
