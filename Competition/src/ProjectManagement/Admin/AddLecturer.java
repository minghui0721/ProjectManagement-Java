...
public class AddLecturer extends javax.swing.JFrame {
    ...
    private Admin admin;
    public AddLecturer(Admin admin) {
        initComponents();
        this.setTitle("Add Lecturer");
        ID.setText(generateLecturerID());
    ...
    private void addLecturer() {
        ...
        Object position = Position.getSelectedItem();
        Object status = Status.getSelectedItem();

        // Write student information to file
        try (FileWriter writer = new FileWriter("lecturer.txt", true); BufferedWriter bw = new BufferedWriter(writer)) {
            bw.write(id + "|" + password + "|" + fname + "|" + lname + "|" + Email + "|" + gender + "|" + Phone + "|" + ic + "|" + Address + "|" + intakeyear + "|" + position + "|" + status);
            bw.newLine();
            JOptionPane.showMessageDialog(this, "Lecturer added successfully.");
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Error occurred while adding lecturer.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void roundedPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel1MouseReleased
        ...
        AmendLecturer addlec = new AmendLecturer(admin);
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        if (!isValidLname(lname)) {
            ...
            ID.setText(generateLecturerID());
            System.out.println(generateLecturerID());
            ID.setEditable(false);
    ...
    private boolean isValidIC(String ic) {
        // Check if IC number consists of exactly 12 characters and has the format XXXXXX-XX-XXXX
