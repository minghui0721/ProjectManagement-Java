...
public class EditLecturer extends javax.swing.JFrame {
    ...
    public EditLecturer(Admin admin, String SpNum, String ePassword, String eFname, String eLname, String eEmail, String eGender, String ePhone, String eIc, String eAddress, String eYear, String eposition, String eStatus) {

        initComponents();
        this.admin = admin;
        this.setTitle("Edit Lecturer");
        //set admin name
        ...
        IntakeYear.setText(eYear);
        Position.setSelectedItem(eposition);
        Status.setSelectedItem(eStatus);
    ...
    private void editLecturer() {
        ...
        if (id.isEmpty() || password.isEmpty() || fname.isEmpty() || lname.isEmpty() || Email.isEmpty() || Phone.isEmpty() || ic.isEmpty() || Address.isEmpty() || intakeyear.isEmpty()) {
    ...
    private String generateLecturerID() {
        // Read the last lecturer ID from the file
        String lastLecturerID = getLastLecturerIDFromFile();

        // Extract the numeric part and increment it by one
        int lastNumber = Integer.parseInt(lastLecturerID.substring(2)); // Extract numeric part after "SP"
        int nextNumber = lastNumber + 1;

        // Generate the next lecturer ID
        String nextLecturerID = String.format("SP%03d", nextNumber);

        // Update the ID GUI component
        ID.setText(nextLecturerID);

        return nextLecturerID;
    }

    private String getLastLecturerIDFromFile() {
        String lastLecturerID = "SP000"; // Default value in case the file is empty
        try (BufferedReader reader = new BufferedReader(new FileReader("lecturer.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                lastLecturerID = line.split("\\|")[0]; // Extract the lecturer ID from each line
            }
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(roundedPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE)
        ...
        jLabel12.setText("Edit Lecturer");
        ...
        jLabel22.setText("Lecturer Details");
    ...
    private void roundedPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel1MouseReleased
        ...
        AmendStudent amendstud = new AmendStudent(admin);
        amendstud.setVisible(true);
    ...
    private void ClearButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClearButtonActionPerformed
        ...
        lName.setText("");
        email.setText("");
        Gender.setSelectedIndex(0); // Assuming index 0 is for a default option, like "Select Gender"
        address.setText("");
        phone.setText("");
        IntakeYear.setText("");
        IC.setText("");
    ...
    private void BackButton(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BackButton
        // TODO add your handling code here:
        this.dispose();
        AmendLecturer back = new AmendLecturer(admin);
