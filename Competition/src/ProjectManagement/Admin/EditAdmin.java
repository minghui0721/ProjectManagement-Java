...
public class EditAdmin extends javax.swing.JFrame {
    ...
    public EditAdmin(Admin admin, String APNumber, String editPassword, String editFname, String editLname, String editemail, String editgender, String editaddress, String editphone, String editIC, String role) {
        initComponents();
        this.setTitle("Edit Admin");
        this.admin = admin;
        //retrieve current admin role
        this.userRole = role;
        //set admin name
        ...
        studentIDText.setText(APNumber);
        passwordText.setText(editPassword); // Store password
    ...
    private void editAdmin() {
        ...
        //    Object intakecode = selectModule.getSelectedItem();
        String IC = ICText.getText();
        // Define a flag to check if the student has been found and updated
        // Check for empty fields
        if (id.isEmpty() || password.isEmpty() || fname.isEmpty() || lname.isEmpty() || email.isEmpty() || phone.isEmpty() || IC.isEmpty() || address.isEmpty()) {
        ...
        // Read the content of the admin.txt file
        ...
        // Write the updated content back to the admin.txt file
        ...
        if (AdminFound) {
            ...
            this.dispose();
            SuperAdmin superad = new SuperAdmin(admin);
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Admin Details");
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(passwordText, javax.swing.GroupLayout.DEFAULT_SIZE, 198, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jLabel27, javax.swing.GroupLayout.DEFAULT_SIZE, 69, Short.MAX_VALUE)
    ...
    private void roundedPanel1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel1MouseReleased
        ...
        AmendStudent Amendstudnet = new AmendStudent(admin);
        Amendstudnet.setVisible(true);
    ...
    private void BackButton(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BackButton
        // TODO add your handling code here:\
        this.dispose();
        SuperAdmin back = new SuperAdmin(admin);
    ...
    private void roundedPanelMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanelMouseMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_roundedPanelMouseMoved
