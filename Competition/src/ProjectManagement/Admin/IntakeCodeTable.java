 ...
 * @author mingh
 */
public class IntakeCodeTable extends javax.swing.JFrame {

    static String IntakeCode;
    private Admin admin;
    public IntakeCodeTable(Admin admin) {
        initComponents();
        this.setTitle("Add Intake Code");
        this.admin = admin;
        //set admin name
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("IntakeCode.txt"))) {
            String line;
            DefaultTableModel model = (DefaultTableModel) IntakeCodeTable.getModel();
    ...
    private void initComponents() {
        ...
        IntakeCodeTable = new ProjectManagement.Admin.Table();
        jLabel20 = new javax.swing.JLabel();
        IntakeCodeText = new javax.swing.JTextField();
        ...
        roundedPanel3.setBackground(new java.awt.Color(254, 239, 198));
        roundedPanel3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel22.setText("Intake Code Generator");
        ...
        generateButton.setBackground(new java.awt.Color(153, 153, 0));
        generateButton.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        generateButton.setText("Generate Intake Code");
        generateButton.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        IntakeCodeTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(IntakeCodeTable);

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel20.setText("Intake Code : ");

        IntakeCodeText.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        IntakeCodeText.setText("APU");
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(IntakeCodeText, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(63, 63, 63)
                        .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(119, 119, 119))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                        .addComponent(generateButton, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(IntakeCodeText, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void roundedPanel2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_roundedPanel2MouseReleased
        ...
        // Open the ProjectHome class
        PM_Lecturer pm = new PM_Lecturer(admin);
        pm.setVisible(true);
    ...
    private void generateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateButtonActionPerformed
        ...
        String intakeCode = IntakeCodeText.getText();
        
        if (!isValidIntakeCode(intakeCode)) {
            JOptionPane.showMessageDialog(this, "Invalid Intake Code format. Intake Code should be in the format: APUXXXXXXXX.", "Error", JOptionPane.ERROR_MESSAGE);
            IntakeCodeText.setText("APU");
            return; // Exit the method if phone number is invalid
        }
        
        try {
            // Assuming IntakeCodeText is a JTextField or similar component where user inputs the text
            

            // Adding the input to the table model
            DefaultTableModel model = (DefaultTableModel) IntakeCodeTable.getModel();
            model.addRow(new Object[]{intakeCode});

            // If you also want to save the input to a file, you can do it here
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("IntakeCode.txt", true))) {
                writer.write(intakeCode);
                writer.newLine();
                JOptionPane.showMessageDialog(this, "Intake Code added successfully.");
            } catch (IOException ex) {
                System.err.println("Issue in writing to file: " + ex.getMessage());
            }
            IntakeCodeText.setText("APU");

        } catch (Exception ex) {
            System.err.println("Error in adding intake code: " + ex.getMessage());
        }
    }//GEN-LAST:event_generateButtonActionPerformed

    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        int selectedRow = IntakeCodeTable.getSelectedRow(); // Get the index of the selected row
        ...
        if (selectedRow >= 0) { // Check if a row is selected
            ...
            try {
                ...
                List<String> lines = Files.readAllLines(Paths.get("IntakeCode.txt"));
                ...
                Files.write(Paths.get("IntakeCode.txt"), lines);

                // Remove the selected row from the JTable
                model.removeRow(selectedRow);
                JOptionPane.showMessageDialog(this, "Intake Code deleted successful !");
            } catch (IOException e) {
                System.err.println("Error deleting Intake Code: " + e.getMessage());
            }
        } else {
            JOptionPane.showMessageDialog(this, "Please Select a Intake Code !");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntakeCodeTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private boolean isValidIntakeCode(String intakecode) {
        return intakecode != null && intakecode.startsWith("APU");
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton DeleteButton;
    private ProjectManagement.Admin.Table IntakeCodeTable;
    private javax.swing.JTextField IntakeCodeText;
