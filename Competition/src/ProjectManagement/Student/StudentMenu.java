...
import ProjectManagement.Lecturer.Model_Card;
...
public class StudentMenu extends javax.swing.JFrame {
    ...
    public StudentMenu(Student student) {
        ...
        int totalProjects = numberOfProjectHandle();
        int totalSubmissions = numberOfSubmission();
        int totalPresentation = getTotalPresentation(student.getId());
        ...
        String totalPresentationString = String.valueOf(totalPresentation);

        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Project", totalProjectsString, "For student"));
        card2.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Presentation", totalPresentationString, "Request"));
        card3.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Result Released", totalSubmissionString, "Project Graded"));
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        String submissionStatus = (String) table1.getValueAt(selectedRow, 5); // Assuming grading status is in column 6
                        String gradingStatus = (String) table1.getValueAt(selectedRow, 6); // Assuming grading status is in column 6
                        String projectID = (String) table1.getValueAt(selectedRow, 0); // Assuming projectID is in the first column

                        if (submissionStatus.equals("Submitted")) {
                            if (gradingStatus.equals("Graded")) {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Student Dashboard");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Project ID", "Project", "Start Date", "End Date", "Intake", "Submission Status", "Grading Status"
            }
        ) {
        ...
        jTextField1.setBackground(new java.awt.Color(108, 87, 233));
        jTextField1.setFont(new java.awt.Font("Franklin Gothic Medium", 1, 12)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        jTextField1.setText("Search by project...");
        jTextField1.setToolTipText("Search by project...");
    ...
    private Map<String, String[]> readStudentHandle() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("project_details.txt"))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (fields.length >= 10 && fields[7].equals(student.getIntakeCode())) {
    ...
    private int numberOfProjectHandle() {
    ...
    private int numberOfSubmission() {
        int totalSubmissions = 0; // Initialize total projects counter
        try (BufferedReader reader = new BufferedReader(new FileReader("submission.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                String[] fields = line.split("\\|"); // Split the line into fields using the '|' separator
                if (fields.length >= 6 && fields[1].equals(student.getId())) {
    ...
    public Object[][] getRowData() {
        ...
        Map<String, String[]> projectDetailsMap = readStudentHandle();
        ...
        for (Map.Entry<String, String[]> entry : projectDetailsMap.entrySet()) {
            ...
            String submissionStatus = checkSubmissionExists(student.getId(), projectID) ? "Submitted" : "Unsubmitted";

            // Check grading status
            String gradingStatus = checkGradingStatus(student.getId(), projectID) ? "Graded" : "Ungraded";

            rowDataList.add(new Object[]{projectID, projectName, startDate, endDate, intake, submissionStatus, gradingStatus});
        }
...
// Method to check if grading exists for a student and project
    ...
    public static int getTotalPresentation(String studentId) {
