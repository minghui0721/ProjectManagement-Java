 ...
 * @author mingh
 */
public class SecondMarkerMenu extends javax.swing.JFrame {

    private Lecturer lecturer;
    private String lecturerId;

    public SecondMarkerMenu(Lecturer lecturer) {
        ...
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/ProjectManagement/Image/stock.png")), "Total Project", totalProjectsString, "Second Marker"));
    ...
    private void initComponents() {
        ...
        setTitle("Second Marker Dashboard");
        ...
        jLabel12.setText("Second Marker Dashboard");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Intake", "Project", "Start Date", "End Date", "Supervisor", "Grading Status"
            }
        ) {
        ...
        for (Map.Entry<String, String[]> entry : projectDetailsMap.entrySet()) {
            ...
            for (String[] studentRecord : studentRecords) {
               ...
               // Check grading status
                String lecturerGradingStatus = lecturer.submissionAndGradingStatus(studentID, projectID);
