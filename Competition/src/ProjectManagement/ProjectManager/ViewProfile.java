...
public class ViewProfile extends javax.swing.JFrame {
     ...
     */
    public ViewProfile(Lecturer projectManager) {
    ...
    public void setLecturerData(Lecturer projectManager) {
        String firstName = projectManager.getFirstName();
        String lastName = projectManager.getLastName();
        ...
        startYearTxt.setText(String.valueOf(projectManager.getStartYearOfWorkingExperience()));
    ...
    EditProfile editProfile = new EditProfile(projectManager);
    // Make the EditProfile page visible
